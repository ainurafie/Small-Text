def fungsikedua(msg):
  ...
  #   #     print(i, end = ' ')
  #   data = "Kata Asli : " + ' '.join(pembenaran_kata)
  #   # print(data)
  #   return data
  ...
  input_kata = word_tokenize(msg) #menambah input ke dalam array
  kata_fix = []
  if len(input_kata) > 1:
    for i in input_kata:
      kata_fix.append(cari(i, predict))
  else:
    kata_fix.append(cari(input_kata[0], predict))

  data = "Kata Asli : " + ' '.join(kata_fix)
  # print(data)
  return data
